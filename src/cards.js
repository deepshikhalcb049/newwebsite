    ...
    return (
        <div className=' bg-black relative flex shrink'>
            <div className='w-[100%] items-center justify-center relative flex flex-col'>
                <div className='mt-[300px] w-[90%] items-center justify-center  flex relative'>
                    <p className='gt bg-clip-text text-white w-[905px]'>Experience your product as you create it.</p>
                </div>
                <div className='mt-[100px] h-[1200px] w-[85%] mr-[-50px] relative  flex flex-col shrink'>
                    <div className=' h-[48%] relative grid grid-cols-3  flex-col shrink'>
                        <div className='  col-span-2'>
                            ...
                            // shadowOffset={2}
                            >
                                <div className='w-[785px] h-[520px] border-[0.08px] border-gray-700 rounded-[26px] bg-[#161B22] relative'>
                        ...
                        <div className='ml-[-40px] relative flex flex-col shrink'>
                            <Atropos
                                className="atropos-banner"
                                highlight={false}
                                activeOffset={40}
                            ...
                            // shadowOffset={2}
                            >
                                <div className='w-[445px] h-[520px] relative  border-[0.08px] border-gray-700 rounded-[26px] bg-[#161B22]'>
                    ...
                    <div className=' h-[48%]   relative grid grid-cols-3'>
                        <div className='mr-[-20px]'>
                            ...
                            // shadowOffset={2}
                            >
                                <div className='w-[445px] h-[520px]  border-[0.08px] border-gray-700 rounded-[26px] bg-[#161B22]'>
                        ...
                        <div className='relative ml-[50px] col-span-2 flex flex-col shrink'>
                            <Atropos
                                className="atropos-banner"
                                highlight={false}
                                activeOffset={0}
                            ...
                            // shadowOffset={2}
                            >
                                <div className='w-[785px] h-[520px]  border-[0.08px] border-gray-700 rounded-[26px] bg-[#161B22]'>
